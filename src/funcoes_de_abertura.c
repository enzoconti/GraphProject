...
Função responsável por retornar um ponteiro de arquivo a partir de uma string que contém o nome do arquivo, o abrindo
no modo para leitura em binário. Se a abertura não obteve sucesso, a função é quebrada e a mensagem de erro para
grafos é exibida.

*/
FILE* abrir_leitura_binario_grafo(char* nome_do_arquivo){
    FILE* arquivo;
    arquivo = fopen(nome_do_arquivo, "rb");
